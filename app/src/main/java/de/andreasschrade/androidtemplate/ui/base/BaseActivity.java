...
import de.andreasschrade.androidtemplate.util.NavigationItemLongPressInterceptor;
...
public abstract class BaseActivity extends AppCompatActivity implements
    ...
    //TODO new
    @Override
    public void onNavigationItemLongClick(NavigationItemLongPressInterceptor.SelectedItem selectedItem,
            View view) {
        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view);
        int menItemId = selectedItem.getItemId(navigationView);

        String text;
        switch (menItemId) {
            case R.id.nav_quotes:
                text = getString(R.string.navigation_quotes);
                TTSStarter.startTTS(this, text);
                break;
            case R.id.nav_samples:
                text = getString(R.string.navigation_samples);
                TTSStarter.startTTS(this, text);
                break;
            case R.id.nav_settings:
                text = getString(R.string.navigation_settings);
                TTSStarter.startTTS(this, text);
                break;
            case R.id.nav_dummy_item_1:
                text = getString(R.string.navigation_dummy_item_1);
                TTSStarter.startTTS(this, text);
                break;
            case R.id.nav_dummy_item_2:
                text = getString(R.string.navigation_dummy_item_2);
                TTSStarter.startTTS(this, text);
                break;
        }
    }
