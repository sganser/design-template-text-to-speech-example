...
public class ArticleDetailFragment extends BaseFragment {
    ...
    @OnLongClick(R.id.author_quote_layout)
    public boolean onAuthorQuoteLayoutLongClick() {
        String text = dummyItem.author +" <break/> "+dummyItem.content;
        TTSStarter.startTTS(getActivity(), text);
        return true;
    }

    @OnLongClick(R.id.more_info_layout)
    public boolean onMoreInfoLayoutLongClick() {
        String text = "More Info <break/> " + getString(R.string.lorem_ipsum);
        TTSStarter.startTTS(getActivity(), text);
        return true;
    }
